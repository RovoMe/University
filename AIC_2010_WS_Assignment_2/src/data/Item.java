...
public class Item
{
	...
	/**
	 * Sets the {@link Order}-object this item is a part of.
	 * @param order {@link Order}-object which includes this item.
	 */
	...
	/**
	 * Returns the {@link Order}-object, this item is a part of.
	 * @return {@link Order}-object which includes this item.
	 */
	...
	public boolean equals(Object obj)
	{
		...
		if (obj instanceof Item)
		{
			...
			if (item.getQuantity() == this.getQuantity()/* &&
					...
					item.getOrder().equals(this.getOrder())*/)
				return true;
		}
		return false;
	}
