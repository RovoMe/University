...
//	)
	...
	/**
	 * Sets the {@link Customer} who lives or works at this address.
	 * @param customer Customer-Object representing the customer at
	 * 		this address.
	 */
	...
	/**
	 * Returns the {@link Customer} located at this address.
	 * @return {@link Customer}-object loacated at this address.
	 */
...
// 					addr.getCustomer().equals(this.getCustomer()))*/
					)
				return true;
		}
		return false;
