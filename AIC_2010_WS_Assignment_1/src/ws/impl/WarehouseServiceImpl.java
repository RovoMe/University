...
@WebService(endpointInterface="ws.WarehouseService", 
		...
		name="WarehousePT") // wird nach portType gemapped
public class WarehouseServiceImpl implements WarehouseService
{
			...
			throws UnknownProductFault
	{
		...
		if (ret.isAvailable())
		{
			...
			System.out.println("[WarehouseService] order for "+amount+" '"+product.getName()+"' received");
			...
			if (details != null)
			{
				...
				System.out.println("[WarehouseService] amount of '"+product.getName()+"' available: "+details.getAmount());
